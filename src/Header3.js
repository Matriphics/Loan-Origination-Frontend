            ...
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    ...
                    <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
                        <Button sx={{ my: 2, color: '#0473ea', display: 'block', fontWeight: '700' }}><Link to='/makerinbox' style={{ textDecoration: 'none', color: 'inherit' }}>Inbox</Link></Button>
                    ...
                    <Box sx={{ flexGrow: 0 }}>
                        ...
                        >
                            ...
                            <MenuItem onClick={handleCloseUserMenu}><Link to='/makerlogin' style={{ textDecoration: 'none', color: 'inherit' }}>Logout</Link></MenuItem>
                        </Menu>
                    </Box>
                </Toolbar>
            </Container>
