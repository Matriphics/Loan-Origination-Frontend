...
export default function HomeLoan() {
  ...
  return (
    <div>
      <Header></Header>
      <div>
        <img src="./homeloanimg.jpg" alt="bg for home loan" width='100%' height={400} />
      </div>
      {/* one */}
              ...
              <Grid item>
                <Accordion sx={{ marginTop: '20px' }}>
                  <AccordionSummary
                    ...
                    id="panel1a-header"
                  >
                    <Typography>Detailed Benefits of SC Home Loans</Typography>
                  </AccordionSummary>
                  <AccordionDetails>
                    <Typography>
                      <Box sx={{ flexGrow: 1 }}>
                          ...
                          <Grid item xs={6}>
                            <Accordion>
                              <AccordionSummary
                                ...
                                id="panel2a-header"
                              >
                                <Typography>What is a home loan?</Typography>
                              </AccordionSummary>
                              <AccordionDetails>
                                <Typography>
                          ...
                          <Grid item xs={6}>
                            <Accordion>
                              <AccordionSummary
                                ...
                                id="panel2a-header"
                              >
                                <Typography>What can  Home loans be used for?</Typography>
                              </AccordionSummary>
                              <AccordionDetails>
                                <Typography>
                                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
                          ...
                          <Grid item xs={6}>
                            <Accordion>
                              <AccordionSummary
                                ...
                                id="panel2a-header"
                              >
                                <Typography>What are the benefits of taking a home loan from SCB?</Typography>
                              </AccordionSummary>
                              <AccordionDetails>
                                <Typography>
                                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
                          ...
                          <Grid item xs={6}>
                            <Accordion>
                              <AccordionSummary
                                ...
                                id="panel2a-header"
                              >
                                <Typography>What are the Eligibility Criteria to get home loans?</Typography>
                              </AccordionSummary>
                              <AccordionDetails>
                                <Typography>
                                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
