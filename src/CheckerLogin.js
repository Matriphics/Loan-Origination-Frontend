...
export default function CheckerLogin(props) {
    ...
    const login = () => {
        ...
        // Custom credentials: username "checker" and password "checkerpass"
        if (username === "checker" && password === "checkerpass") {
    ...
    useEffect(() => {
        // Generate two random numbers between 1-10 for the captcha
        let newCaptcha = {
