...
export default function PersonalLoan() {
    ...
    var [currency, setCurrency] = React.useState("Rs.");
    const handleChange = (event) => {
    ...
    return (
        <div>
            <Header></Header>
            <div>
                <img src="./personalloanimg.jpg" alt="bg for personal loan" width='100%' height={400} />
            </div>
            {/* one */}
                            ...
                            <Grid item>
                                <Accordion sx={{ marginTop: '20px' }}>
                                    <AccordionSummary
                                        ...
                                        id="panel1a-header"
                                    >
                                        <Typography>Detailed Benefits of SC Personal Loans</Typography>
                                    </AccordionSummary>
                                    <AccordionDetails>
                                        <Typography>
                                            <Box sx={{ flexGrow: 1 }}>
                                                    ...
                                                    <Grid item xs={6}>
                                                        <Accordion>
                                                            <AccordionSummary
                                                                ...
                                                                id="panel2a-header"
                                                            >
                                                                <Typography>What is a personal loan?</Typography>
                                                            </AccordionSummary>
                                                            <AccordionDetails>
                                                                <Typography>
                                                    ...
                                                    <Grid item xs={6}>
                                                        <Accordion>
                                                            <AccordionSummary
                                                                ...
                                                                id="panel2a-header"
                                                            >
                                                                <Typography>What are personal loans used for?</Typography>
                                                            </AccordionSummary>
                                                            <AccordionDetails>
                                                                <Typography>
                                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
                                                    ...
                                                    <Grid item xs={6}>
                                                        <Accordion>
                                                            <AccordionSummary
                                                                ...
                                                                id="panel2a-header"
                                                            >
                                                                <Typography>What are the benefits of taking a personal loan from SCB?</Typography>
                                                            </AccordionSummary>
                                                            <AccordionDetails>
                                                                <Typography>
                                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
                                                    ...
                                                    <Grid item xs={6}>
                                                        <Accordion>
                                                            <AccordionSummary
                                                                ...
                                                                id="panel2a-header"
                                                            >
                                                                <Typography>What are the Eligibility Criteria to get personal loan?</Typography>
                                                            </AccordionSummary>
                                                            <AccordionDetails>
                                                                <Typography>
                                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
