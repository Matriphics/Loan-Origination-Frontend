...
export default function ApplicationChecker() {
    ...
    const handlereject = () => {
        var config = {
            method: 'patch',
            url: 'http://localhost:9090/checker/reject/' + id,
            headers: {},
        };
    ...
    const handleapprove = () => {
        var config = {
            method: 'patch',
            url: 'http://localhost:9090/checker/approve/' + id,
            headers: {},
        };
    ...
    const handlesendmaker = () => {
        var config = {
            method: 'patch',
            url: 'http://localhost:9090/checker/sendtomaker/' + id,
            headers: {},
        };
    ...
    const handlename = (e) => setCustomers({ ...customers, applicant_name: e.target.value })
                    ...
                    <Box sx={{ width: '100%' }}>
                        ...
                        <CustomTabPanel value={value} index={2}>
                            <Grid container spacing={3}>
                                ...
                                <br /><br />
                                <Grid item sx={{ mx: 8, my: 10 }}>
                                    <Button variant="contained" onClick={handlereject}>
                                        <Link to='/checkerinbox' style={{ textDecoration: 'none', color: 'inherit' }}>Reject</Link>
                                    </Button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <Button variant="contained" onClick={handlesendmaker}>
                                        <Link to='/checkerinbox' style={{ textDecoration: 'none', color: 'inherit' }}>Send to Maker</Link>
                                    </Button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <Button variant="contained" onClick={handleapprove}>
                                        <Link to='/checkerinbox' style={{ textDecoration: 'none', color: 'inherit' }}>Approve</Link>
                                    </Button>
                                </Grid>
                            </Grid>
                        </CustomTabPanel>
